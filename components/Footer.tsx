...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-brand-dark border-t border-white/10 text-white py-16 relative z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    {/* Brand Section */}
                    <div className="col-span-1 md:col-span-2">
                        <Link to="/" className="text-3xl font-playfair font-bold mb-6 block">
                    ...
                    <div className="col-span-1">
                        <h4 className="font-playfair font-bold text-lg mb-6 text-white">Explore</h4>
                    ...
                    {/* About Links */}
                    <div className="col-span-1">
                         <h4 className="font-playfair font-bold text-lg mb-6 text-white">About</h4>
                         <ul className="space-y-4 text-sm text-white/60">
                            <li>
