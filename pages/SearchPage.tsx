...
const SearchPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const results = cities.flatMap(city => 
            ...
            if (!searchTerm && !tagParam && (selectedCity !== 'All' || selectedPrice !== null || minRating > 0)) {
                return true;
            }
    ...
    }, [searchTerm, tagParam, selectedCity, selectedPrice, minRating]);
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 relative z-10">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-8">
                        ...
                        {/* Filters */}
                        <div className="flex flex-col md:flex-row flex-wrap justify-center gap-4 md:gap-6 animate-fade-in">
                             {/* City Select */}
                             <div className="relative">
                                <select
                                    value={selectedCity}
                                    onChange={(e) => setSelectedCity(e.target.value)}
                                    className="appearance-none bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-full py-2 pl-4 pr-10 focus:outline-none focus:border-brand-primary transition-colors cursor-pointer text-sm"
                                >
                ...
                <div className="text-center border-b border-white/10 pb-8">
                    <p className="text-white/60 text-lg font-light">
                        {filteredRestaurants.length > 0 ? (
                            ...
                            searchTerm || tagParam || selectedCity !== 'All' || selectedPrice !== null || minRating > 0 ? (
